...
mainWindow(showMe) {
  ...
  Menu, MainMenu, Add, Exit the app X, exit 
...
;--------------------------------- showHelp ---------------------------------
; showHelp(){
  ; global hMain, infoBoxHelp, focusdummy, windowPosY, app
  ; global font, fontsize
  
  ; widthLine := " ****************************************************** `n"
  ; helpMsg := widthLine

  ; helpMsg .= "Without any Starparameter:" . ",`n"
  ; helpMsg .= "startdelayed -> run all defined StartCmds" . ",`n`n"
  ; helpMsg .= "With Starparameter:" . ",`n"
  ; helpMsg .= "startdelayed stopall -> run all defined StopCmds" . ",`n"
  ; helpMsg .= "or" . ",`n"
  ; helpMsg .= "startdelayedStopall.exe -> run all defined StopCmds" . ",`n"
  
  ; helpMsg .= "Open StartDelayed in edit-mode:" . ",`n"
  ; helpMsg .= "startdelayedEdit.exe" . ",`n"
  ; helpMsg .= "or" . ",`n"
  ; helpMsg .= "startdelayed editmode" . ",`n`n"
  ; helpMsg .= "In edit-mode:" . ",`n"
  ; helpMsg .= "Click on row -> execute the StartCmd" . ",`n"
  ; helpMsg .= "[Ctrl] + click on row -> execute the StopCmd" . ",`n"
  ; helpMsg .= "[Shift] + click on row -> Edit row" . ",`n"
  
  ; helpMsg .= widthLine
  
  ; gui, infoBox:new, hwndhHelp +E0x08000000 -resize +parentGuiMain +ownerGuiMain, %app%
  ; gui, infoBox:Font, s%fontsize%, %font%
  
  ; Gui, infoBox:Add, edit, x0 y0 w0 h0 Vfocusdummy
  ; Gui, infoBox:Add, edit,ReadOnly x5 y5 r30 VinfoBoxHelp,%helpMsg%
  ; gui, infoBox:Show,center autosize
  
  ; WinCenter(hMain, hHelp, 1)
